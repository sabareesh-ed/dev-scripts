...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const setInitialValues = () => {
    ...
    endTrigger = stickyVideoWrapper.getBoundingClientRect().top + window.scrollY - viewportHeight * 0.05; // 20% of the viewport
...
document.querySelectorAll("[data-nav-change]").forEach((element) => {
  gsap.to("[data-nav]", {
    ...
    scrollTrigger: {
      trigger: element,
      start: "top 5%", // Start when the top of `data-nav-change` reaches 30% of the viewport
