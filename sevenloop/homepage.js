...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const setInitialValues = () => {
    ...
    startTrigger = stickyVideoWrapper.getBoundingClientRect().top + window.scrollY - viewportHeight * 0.5; // 90% of the viewport
    endTrigger = stickyVideoWrapper.getBoundingClientRect().top + window.scrollY - viewportHeight * 0.8; // 20% of the viewport
